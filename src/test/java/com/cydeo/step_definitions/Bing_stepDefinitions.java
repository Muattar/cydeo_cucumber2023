...
public class Bing_stepDefinitions {
    ...
    public void user_enters_orange_in_the_bing_search_box() {
        bingSearchPage.searchBingBox.sendKeys("orange" + Keys.ENTER);
    ...
    public void SearchBox(String searchBox) {
        ...
        bingSearchPage.searchBingBox.sendKeys(searchBox + Keys.ENTER);

    }

    @Then("user should see {string} in the title")
    public void Title_verification(String expectedTitle) {
